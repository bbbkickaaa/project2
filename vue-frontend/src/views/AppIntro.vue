    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container px-5">
                <a class="navbar-brand" href="#page-top">JamDongSan</a>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <p><br><br>서로의 의견을 존중해주세요! <br><br> 분란을 목적으로 하는 글은 임의 삭제될 수  있습니다.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            <h2 class="display-4">Vue.js 3 +<br> Spring boot</h2>
                            <p><br><br>해당 사이트는 뷰와 스프링부트로 제작되었습니다. <br><br> Mvvm + Spa 패턴을 따르고 있습니다.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="py-5 bg-black">
            <div class="container px-5"><p class="m-0 text-center text-white small">Copyright &copy; JamDongSan</p></div>
        </footer>
    </body>
    <!-- 로그인 모달 컴포넌트 -->
    <modal-component :show="showLoginModal" @close="showLoginModal = false, SwitchLoginForm='login'" >
...
.alert-primary {
  --bs-alert-color: #8f0549;
  --bs-alert-bg: #fccee4;
  --bs-alert-border-color: #fab5d7;
}
...
.alert-secondary {
  --bs-alert-color: #994000;
  --bs-alert-bg: #ffe1cc;
  --bs-alert-border-color: #ffd2b3;
}
